...
<body>
  ...
  <div class="section">
    <p style="text-align: center; font-style: italic; margin-bottom: 20px;">
      Fait à ${data.companyCity}, le ${today}
    </p>

    <div class="field">
      <span class="label">Entre :</span>
      <span class="value"><strong>${data.companyName}</strong><br>
      ${data.companyAddress}<br>
      ${data.companyPostalCode} ${data.companyCity}<br>
      SIRET : ${data.companySiret}</span>
    </div>
    <div class="field">
    ...
    <div class="field">
      <span class="label">Ci-après dénommée "l'employeur"</span>
    </div>

    <div class="field" style="margin-top: 20px;">
      <span class="label">Et :</span>
      <span class="value"><strong>${data.employeeFirstName} ${data.employeeLastName}</strong><br>
      ${data.employeeAddress}<br>
      ${data.employeePostalCode} ${data.employeeCity}<br>
      Né(e) le ${new Date(data.employeeBirthDate).toLocaleDateString('fr-FR')}<br>
      Nationalité : ${data.employeeNationality}</span>
    </div>
    <div class="field">
      <span class="label">Ci-après dénommé(e) "le salarié"</span>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      ${data.durationWeeks ? `
      <div class="field">
        <span class="label">Durée du contrat :</span>
        <span class="value">${data.durationWeeks} semaines</span>
      </div>
      ` : ''}
    </div>
    ...
    <div class="article" style="margin-top: 20px;">
      ...
      <p style="margin: 10px 0; padding: 10px; background: #f5f5f5; border-left: 4px solid ${accentColor};">
        <strong>${data.contractReason || 'Remplacement'}</strong>
      </p>
      ${data.replacedEmployeeName ? `
      <p style="margin-top: 10px;">Salarié remplacé : <strong>${data.replacedEmployeeName}</strong></p>
      ` : ''}
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Le motif de recours au CDD doit correspondre à l'un des cas prévus par l'article L. 1242-2 du Code du travail.
      </p>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt;">
        Cette durée ne peut excéder une durée calculée à raison d'un jour par semaine de travail dans la limite de :
      </p>
      <ul>
  ...
  <div class="section">
    <div class="article">
      ...
      <div class="field">
        <span class="label">Classification conventionnelle :</span>
  ...
  <div class="section">
    <div class="article">
      ...
      <div class="field">
        ...
        <span class="value">${data.workingHours} heures</span>
      </div>
      ` : ''}
      <p style="margin-top: 10px; font-size: 10pt;">
        La durée légale du travail est fixée à 35 heures hebdomadaires (articles L. 3121-27 et suivants du Code du travail).
      </p>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <div class="field" style="margin-top: 10px;">
        <span class="label">Convention collective applicable :</span>
        <span class="value">${data.collectiveAgreement}</span>
      </div>
      ` : ''}
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Cette clause doit être limitée dans le temps, dans l'espace, indispensable à la protection des savoir-faire de l'entreprise et comporter l'obligation pour l'employeur de verser au salarié une contrepartie financière (articles L. 3142-16 et suivants du Code du travail).
      </p>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Le taux peut être limité à 6% par accord collectif si des contreparties sont prévues (accès à la formation professionnelle, etc.).
      </p>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Conformément à l'article L. 1411-1 du Code du travail, le Conseil de prud'hommes est compétent pour trancher les litiges individuels nés du contrat de travail.
      </p>
    </div>
  </div>
  ...
  <div class="signature-area">
    <div class="signature-box">
      <div class="field" style="border: none;">
        <span class="label" style="color: #333; font-weight: bold;">L'EMPLOYEUR</span>
      </div>
    ...
    <div class="signature-box">
      <div class="field" style="border: none;">
        <span class="label" style="color: #333; font-weight: bold;">LE SALARIÉ</span>
      </div>
      <div style="margin: 10px 0;">
  ...
  <div class="footer">
    ...
    <p style="margin-top: 10px;">Document généré le ${new Date().toLocaleDateString('fr-FR')} à ${new Date().toLocaleTimeString('fr-FR')} | Conforme au Code du travail français 2024</p>
  </div>
</body>
</html>`;
}
...
<body>
  ...
  <div class="section">
    ...
    <div class="field">
      <span class="label">Qualification / Diplôme :</span>
      <span class="value">${data.employeeQualification}</span>
    </div>
    ` : ''}
    <div class="field">
      <span class="label">Ci-après dénommé(e) "le salarié"</span>
  ...
  <div class="section">
    <div class="article">
      ...
      <div class="article" style="margin-top: 15px;">
        ...
        <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
          Cette clause doit être justifiée par la fonction du salarié et prévoir une contrepartie financière (articles L. 1221-1 et suivants du Code du travail).
        </p>
      </div>
      ` : ''}
    </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt;">
        Conformément à l'article L. 1221-19 du Code du travail, la durée de la période d'essai ne peut excéder :
      </p>
      <ul>
      ...
      <p style="margin-top: 10px;">La période d'essai pourra être renouvelée une fois, d'un commun accord entre les deux parties, dans la limite des durées prévues par l'article L. 1221-21 du Code du travail.</p>
      ` : ''}
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      ` : ''}
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Le salaire sera versé mensuellement, accompagné d'un bulletin de paie conforme aux articles L. 3243-1 et suivants du Code du travail.
      </p>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Cette clause doit être indispensable à la protection des savoir-faire de l'entreprise et comporter l'obligation pour l'employeur de verser au salarié une contrepartie financière (articles L. 3142-16 et suivants du Code du travail).
      </p>
      ` : '<p>Aucune clause de non-concurrence n\'est prévue au présent contrat.</p>'}
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Cette clause doit être nécessaire à la protection des intérêts légitimes de l'entreprise et justifiée par la nature du poste ou les fonctions du salarié.
      </p>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Conformément aux articles L. 1234-1 et suivants du Code du travail.
      </p>
    </div>
  </div>
...
<body>
  ...
  <div class="section">
    ...
    <div class="field">
      <span class="label">Ci-après dénommée "l'entreprise"</span>
    </div>
    ...
    <div class="field">
      <span class="label">Ci-après dénommé(e) "le stagiaire"</span>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      ${data.speciality ? `
      <div class="field">
        <span class="label">Spécialité / Domaine :</span>
  ...
  <div class="section">
    <div class="article">
      ...
      ${data.durationWeeks ? `
      <div class="field">
        <span class="label">Durée du stage :</span>
        <span class="value">${data.durationWeeks} semaines (${daysWorked} jours ouvrés)</span>
      </div>
      ` : ''}
  ...
  <div class="section">
    <div class="article">
      ...
      ` : ''}
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Les missions confiées au stagiaire doivent être en adéquation avec son cursus de formation et lui permettre d'acquérir des compétences professionnelles.
      </p>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <div class="field">
        <span class="label">Heures hebdomadaires :</span>
        <span class="value">${data.workingHours} heures maximum</span>
      </div>
      ` : ''}
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt;">
        Le stagiaire a accès aux activités sociales et culturelles de l'entreprise (articles L. 612-12 et D. 612-1 du Code de l'éducation).
      </p>
    </div>
  </div>
  ...
  <div class="signature-area">
    <div class="signature-box">
      <div class="field" style="border: none;">
        <span class="label" style="color: #333; font-weight: bold;">L'ENTREPRISE</span>
      </div>
      <div style="margin: 10px 0;">
        ${data.employerSignature ? `<img src="${data.employerSignature}" class="signature-img" alt="Signature entreprise">` : '<br><br><br>'}
      </div>
      <div style="margin-top: auto; font-size: 9pt; color: #666;">
        ${data.companyName}<br>
        ${data.employerName}, ${data.employerTitle}<br>
    ...
    <div class="signature-box">
      <div class="field" style="border: none;">
        <span class="label" style="color: #333; font-weight: bold;">LE STAGIAIRE</span>
      </div>
      <div style="margin: 10px 0;">
        ${data.employeeSignature ? `<img src="${data.employeeSignature}" class="signature-img" alt="Signature stagiaire">` : '<br><br><br>'}
      </div>
      <div style="margin-top: auto; font-size: 9pt; color: #666;">
        ${data.employeeFirstName} ${data.employeeLastName}<br>
        ${data.employeeAddress}<br>
  ...
  <div class="footer">
    <p><strong>ATTENTION :</strong> Ce document est un modèle de convention de stage. Il ne constitue pas un avis juridique. Pour une validation juridique définitive, faites relire cette convention par un avocat ou juriste spécialisé.</p>
    <p style="margin-top: 10px;">Document généré le ${new Date().toLocaleDateString('fr-FR')} à ${new Date().toLocaleTimeString('fr-FR')} | Conforme à la loi n° 2014-788 du 10 juillet 2014</p>
  </div>
</body>
</html>`;
}
...
<body>
  ...
  <div class="section">
    ...
    <div class="field" style="margin-top: 20px;">
      ...
      ${data.employeeAddress}<br>
      ${data.employeePostalCode} ${data.employeeCity}<br>
      Né(e) le ${new Date(data.employeeBirthDate).toLocaleDateString('fr-FR')} (${employeeAge} ans)<br>
      Nationalité : ${data.employeeNationality}</span>
    </div>
    ${data.schoolName ? `
    <div class="field">
      <span class="label">Centre de formation d'apprentis :</span>
      <span class="value">${data.schoolName}</span>
    </div>
    ` : ''}
    <div class="field">
      <span class="label">Ci-après dénommé(e) "l'apprenti"</span>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      ${data.contractClassification ? `
      <div class="field">
        <span class="label">Diplôme préparé :</span>
        <span class="value">${data.contractClassification}</span>
      </div>
      ` : ''}
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Le salaire de l'apprenti ne peut être inférieur au SMIC ni au salaire minimum conventionnel applicable.
      </p>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Conformément aux articles L. 6222-18 et suivants du Code du travail.
      </p>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Conformément à l'article L. 1411-1 du Code du travail.
      </p>
    </div>
  </div>
  ...
  <div class="signature-area">
    ...
    <div class="signature-box">
      <div class="field" style="border: none;">
        <span class="label" style="color: #333; font-weight: bold;">L'APPRENTI</span>
      </div>
      <div style="margin: 10px 0;">
        ${data.employeeSignature ? `<img src="${data.employeeSignature}" class="signature-img" alt="Signature apprenti">` : '<br><br><br>'}
      </div>
      <div style="margin-top: auto; font-size: 9pt; color: #666;">
        ${data.employeeFirstName} ${data.employeeLastName}<br>
        ${data.employeeAddress}<br>
  ...
  <div class="footer">
    <p><strong>ATTENTION :</strong> Ce document est un modèle de contrat d'apprentissage. Il ne constitue pas un avis juridique. Pour une validation juridique définitive, faites relire ce contrat par un avocat ou juriste spécialisé.</p>
    <p style="margin-top: 10px;">Document généré le ${new Date().toLocaleDateString('fr-FR')} à ${new Date().toLocaleTimeString('fr-FR')} | Conforme au Code du travail français 2024</p>
  </div>
</body>
</html>`;
...
export function generateContract(data: ContractTemplateData): string {
  switch (data.contractType) {
    ...
    case 'interim':
      // Pour l'instant, utilise le template CDD comme base (à améliorer)
      return generateCDDContract({ ...data, contractReason: 'Mission intérim' });
    case 'portage':
      // Pour le portage salarial, utilise le template CDI comme base (à améliorer)
      return generateCDIContract(data);
    case 'freelance':
      // Pour freelance, génère un template spécifique
...
<body>
  ...
  <div class="section">
    ...
    <div class="field">
      <span class="label">Ci-après dénommée "le client"</span>
    </div>
    ...
    ${data.employeeQualification ? `
    <div class="field">
      <span class="label">Qualification / Spécialité :</span>
      <span class="value">${data.employeeQualification}</span>
    </div>
    ` : ''}
    <div class="field">
      <span class="label">Ci-après dénommé(e) "le prestataire"</span>
    </div>
  </div>
  ...
  <div class="section">
    <div class="article">
      ...
      ${data.speciality ? `
      <div class="field">
        <span class="label">Domaine / Spécialité :</span>
        <span class="value">${data.speciality}</span>
      </div>
      ` : ''}
  ...
  <div class="section">
    <div class="article">
      ...
      ${data.workSchedule ? `
      <div class="field">
        <span class="label">Planning / Disponibilités :</span>
        <span class="value">${data.workSchedule}</span>
      </div>
      ` : ''}
    </div>
  ...
  <div class="section">
    <div class="article">
      ...
      <p style="margin-top: 10px; font-size: 10pt; font-style: italic;">
        Conformément à l'article L. 141-5 du Code de commerce.
      </p>
    </div>
  </div>
  ...
  <div class="signature-area">
    <div class="signature-box">
      <div class="field" style="border: none;">
        <span class="label" style="color: #333; font-weight: bold;">LE CLIENT</span>
      </div>
      <div style="margin: 10px 0;">
        ${data.employerSignature ? `<img src="${data.employerSignature}" class="signature-img" alt="Signature client">` : '<br><br><br>'}
      </div>
      <div style="margin-top: auto; font-size: 9pt; color: #666;">
        ${data.companyName}<br>
        ${data.employerName}, ${data.employerTitle}<br>
    ...
    <div class="signature-box">
      <div class="field" style="border: none;">
        <span class="label" style="color: #333; font-weight: bold;">LE PRESTATAIRE</span>
      </div>
      <div style="margin: 10px 0;">
        ${data.employeeSignature ? `<img src="${data.employeeSignature}" class="signature-img" alt="Signature prestataire">` : '<br><br><br>'}
      </div>
      <div style="margin-top: auto; font-size: 9pt; color: #666;">
        ${data.employeeFirstName} ${data.employeeLastName}<br>
        ${data.employeeAddress}<br>
  ...
  <div class="footer">
    <p><strong>ATTENTION :</strong> Ce document est un modèle de contrat de prestation de service. Il ne constitue pas un avis juridique. Pour une validation juridique définitive, faites relire ce contrat par un avocat ou juriste spécialisé.</p>
    <p style="margin-top: 10px;">Document généré le ${new Date().toLocaleDateString('fr-FR')} à ${new Date().toLocaleTimeString('fr-FR')} | Conforme au Code civil français</p>
  </div>
</body>
</html>`;
}
