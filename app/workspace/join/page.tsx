    ...
    <div className="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden">
      ...
      {state === 'valid' && (
        <div className="p-8 text-center">
          ...
          <p className="text-sm text-gray-500 mb-1">
            ...
            <strong className="text-gray-800">{ROLE_LABELS[role] ?? role}</strong>.
          </p>
      ...
      {(state === 'expired' || state === 'error') && (
        <div className="p-8 text-center">
          ...
          <Link
            href="/login"
            className="block w-full py-3 bg-gray-900 text-white rounded-xl font-bold text-center hover:bg-gray-800 transition-colors"
          >
            Retour à l'accueil
          </Link>
        </div>
      ...
      {state === 'already' && (
        <div className="p-8 text-center">
          ...
          <Link
            href="/dashboard"
            className="block w-full py-3 bg-primary text-white rounded-xl font-bold text-center hover:bg-primary-dark transition-colors"
          >
            Aller au dashboard
          </Link>
        </div>
