      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
            Gérez les acomptes et demandes de paiement
          </p>
          ...
          <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl rounded-3xl p-8 border border-primary/20">
            ...
            <ul className="text-left space-y-3 max-w-md mx-auto mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700 dark:text-gray-300">Créer des demandes d'acompte</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-300">Suivre les paiements partiels</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-300">Générer les factures d'acompte</span>
              </li>
            </ul>
            <Link
              href="/documents"
