          ...
          <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl rounded-3xl p-8 border border-primary/20">
            ...
            <ul className="text-left space-y-3 max-w-md mx-auto mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700 dark:text-gray-300">Créer des bons de commande</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-300">Convertir en factures</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-300">Suivre les livraisons</span>
              </li>
            </ul>
            <Link
              href="/documents"
