...
import {
  ...
  Wallet, Trash2, CheckSquare, X, Lock, Edit2,
} from 'lucide-react';
                          ...
                          <div className="flex items-center justify-end gap-1">
                            {sub.canEditInvoice ? (
                              <Link
                                ...
                                className="p-1.5 rounded-lg hover:bg-blue-50 text-blue-500 hover:text-blue-600 transition-all opacity-0 group-hover:opacity-100"
                                title="Modifier"
                              >
                                <Edit2 size={14} />
                              </Link>
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-lg hover:bg-gray-50 text-gray-300 hover:text-gray-500 transition-all opacity-0 group-hover:opacity-100"
                  ...
                  >
                    ...
                    {sub.canEditInvoice ? (
                      <Link
                        href={`/invoices/${inv.id}/edit`}
                        onClick={(e) => e.stopPropagation()}
                        className="p-1.5 rounded-lg hover:bg-blue-50 text-blue-500 hover:text-blue-600 transition-all opacity-0 group-hover:opacity-100 flex-shrink-0"
                      >
                        <Edit2 size={14} />
                      </Link>
                    ) : (
                      <button
                        onClick={(e) => { e.stopPropagation(); router.push('/paywall'); }}
                        className="p-1.5 rounded-lg hover:bg-gray-50 text-gray-300 hover:text-gray-500 transition-all opacity-0 group-hover:opacity-100 flex-shrink-0"
                      >
                        <Lock size={14} />
                      </button>
                    )}
          ...
          <div className="flex items-center gap-2 bg-gray-900 text-white rounded-2xl shadow-2xl shadow-black/30 px-4 py-3 border border-white/10 backdrop-blur-sm">
            ...
            <div className="flex-1 flex items-center gap-2 flex-wrap">
              ...
              {sub.isFree && selectedIds.size > 0 && (
                <Link
                  href="/paywall"
                  className="flex items-center gap-1.5 bg-amber-500 hover:bg-amber-400 text-white text-xs font-semibold px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap"
                >
                  <Lock size={13} />
