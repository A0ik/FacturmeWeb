    ...
    <div className="max-w-4xl space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-400 mt-0.5">Remplissez les informations ci-dessous pour creer votre document.</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center space-y-5 shadow-sm">
          {!sub.canUseVoice && (
            <button
              ...
              className="flex items-center gap-3 bg-amber-50 border border-amber-200 rounded-xl p-3.5 text-left hover:border-amber-300 transition-colors w-full"
            >
            ...
            <div className="space-y-1 text-center">
              ...
              <p className="text-sm text-gray-500 font-medium">
                {loading
                  ...
                  : recording
                  ? 'Parlez clairement — cliquez pour arreter'
                  : 'Cliquez pour commencer la dictee'}
              </p>
              {!recording && !loading && (
                <p className="text-xs text-gray-300">
                  Ex: "Facture pour Entreprise XYZ, design web 5 jours a 2000e, TVA 20%"
                </p>
              )}
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4 shadow-sm">
          {!sub.canUseVoice && (
            ...
            >
              ...
              <div>
                <p className="text-sm font-bold text-amber-800">Disponible avec Solo ou Pro</p>
                <p className="text-xs text-amber-600 mt-0.5">Decrivez votre facture en texte, l'IA remplit tout</p>
              </div>
            </button>
          )}
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-sm font-bold text-gray-900">Decrivez votre facture</h3>
            </div>
            <p className="text-xs text-gray-400 mb-3">
              Ex: "Facture pour Entreprise XYZ pour developpement web, 5 jours a 2000€ HT, TVA 20%"
            </p>
            <textarea
              value={aiPrompt}
              ...
              placeholder="Decrivez votre facture en langage naturel..."
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            {lastGenSource && (
              <div className="flex items-start gap-3 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
                <div className="w-8 h-8 rounded-xl bg-emerald-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                  {lastGenSource === 'ai' ? <Wand2 size={15} className="text-emerald-600" /> : <Mic size={15} className="text-emerald-600" />}
                </div>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <button
                    ...
                    className="text-xs text-emerald-700 font-semibold hover:text-emerald-900 underline underline-offset-2 transition-colors"
                  >
                    {lastGenSource === 'ai' ? 'Modifier par IA →' : 'Re-dicter →'}
                  </button>
                  <button onClick={() => setLastGenSource(null)} className="p-1 rounded text-emerald-400 hover:text-emerald-600 transition-colors">
                    <X size={13} />
                  </button>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
              ...
              <div className="p-4 space-y-2">
                ...
                <button
                  onClick={addItem}
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border-2 border-dashed border-gray-200 text-gray-400 hover:border-primary/40 hover:text-primary text-sm font-semibold transition-all"
                >
                  <Plus size={15} />
                  Ajouter une ligne
                </button>
                  ...
                  <div className="flex gap-1.5 mt-2">
                    {[5, 10, 15, 20].map((p) => (
                      <button
                        ...
                        className="text-xs px-2 py-1 rounded-lg font-semibold transition-colors bg-gray-100 text-gray-500 hover:bg-primary/10 hover:text-primary"
                      >
                        {p}%
                      </button>
                    ))}
